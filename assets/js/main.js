...
let flg_end_hide = false,
  ...
  min_ang = 40,
  max_ang = 150;
  let arr_words = ["Advertising*Agency","ROI *Focused","Proactive &*Transparent","Digital*Marketeers","Cool *Nerds"];
...
(function($) {
  ...
  arr_words.forEach(element => {
    ...
    for ( let i = 0 ; i < element.length ; i ++ ){
      ...
      else if(element[i] == " ") innerHtmlStr += '<div class="letter">&nbsp;</div>';
